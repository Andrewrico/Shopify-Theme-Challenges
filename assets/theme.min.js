! function (t, e) {
    ...
    function i(t) {
        ...
        return void 0 === this.stylesheetPromise && (this.stylesheetPromise = new Promise(t => {
            ...
            n.loaded && t(), window.onloadCSS(n, function () {
                t()
            })
    ...
    function o(t) {
        ...
        e.innerHTML = t.selectedOptions[0].label, document.querySelector(".footer").appendChild(e);
    ...
    function c(t, e = "min") {
        return `(${e}-width: ${{medium:"46.85em",large:"61.85em",widescreen:"87.5em"}[t]})`
    }
    ...
    function h(t) {
        var e = d();
        return delete e.headers["Content-Type"], e.method = "POST", e.body = t, l("/cart/add.js", e)
    }

    function m(t, e) {
        var n = d();
        return e = e || {}, n.method = "POST", n.body = JSON.stringify({
            line: t,
            quantity: e.quantity,
    ...
    function p(t) {
        var e = d();
        return e.method = "POST", e.body = JSON.stringify(t), l("/cart/update.js", e)
    }

    function f(t) {
        if ("string" != typeof t || 2 !== t.split(":").length) throw new TypeError("Theme Cart: Provided key value is not a string with the format xxx:xxx")
    }

    function g(t) {
        if ("number" != typeof t || isNaN(t)) throw new TypeError("Theme Cart: An object which specifies a quantity or properties value is required")
    }

    function y(t) {
        if ("number" != typeof t || isNaN(t)) throw new TypeError("Theme Cart: Variant ID must be a number")
    }

    function v(t) {
        if ("object" != typeof t) throw new TypeError("Theme Cart: Properties must be an object")
    }

    function w(t) {
        if (!(t instanceof HTMLFormElement)) throw new TypeError("Theme Cart: Form must be an instance of HTMLFormElement")
    }

    function b(t) {
        if ("object" != typeof t) throw new TypeError("Theme Cart: Options must be an object");
        if (void 0 === t.quantity && void 0 === t.properties) throw new Error("Theme Cart: You muse define a value for quantity or properties");
        void 0 !== t.quantity && g(t.quantity), void 0 !== t.properties && v(t.properties)
    }
    ...
    function L(t, e) {
        return f(t), b(e), E(t).then(function (t) {
            return m(t, e)
        })
    }
    ...
    function A(t, e) {
        return q(t), H(e), t.variants.filter(function (t) {
    ...
    class W {
        ...
        init() {
            this.elements = this._getElements(), this._bindEvents(), this.keyUpHandler = this._onKeyUp.bind(this), this.scrollPosition = window.pageYOffset
        }
        openPopup(t) {
            t.preventDefault && t.preventDefault(), this._prepareAnimation(), this.elements.stage.classList.add(R.open), this._sleepAnimation(), this.elements.focus ? e.trapFocus(this.elements.popup, {
                elementToFocus: this.elements.focus
            }) : e.trapFocus(this.elements.popup), this.elements.triggerNode = t.currentTarget, this.elements.triggerNode.setAttribute("aria-expanded", !0), this._enableScrollLock(), document.addEventListener("keyup", this.keyUpHandler)
        }
        closePopup(t = !0) {
            this._prepareAnimation(), this.elements.stage.classList.remove(R.open), this._sleepAnimation(), t && (e.removeTrapFocus(), this.elements.triggerNode.focus(), document.removeEventListener("keyup", this.keyUpHandler)), this.elements.triggerNode.setAttribute("aria-expanded", !1), this._disableScrollLock(), this.elements.triggerNode.dispatchEvent(new window.CustomEvent("popup_closed"))
        }
        getElements() {
            return this.elements
        }
        resetContainerFocus() {
            e.removeTrapFocus(), this.elements.focus ? e.trapFocus(this.elements.popup, {
                elementToFocus: this.elements.focus
        ...
        _enableScrollLock() {
            this.scrollPosition = window.pageYOffset, document.body.style.top = `-${this.scrollPosition}px`, document.body.classList.add(R.preventScrolling)
        }
        _disableScrollLock() {
            document.body.classList.remove(R.preventScrolling), document.body.style.removeProperty("top"), window.scrollTo(0, this.scrollPosition)
        }
        _onKeyUp(t) {
    ...
    class K {
        ...
        init() {
            ...
            Object.assign(this.elements, this.getCartElements(), this.getItemElements()), this.bindContextOfThis(), this.debouncedOnCartItemInput = n((t, e) => {
                this.onCartItemInput(t, e)
            }, 300), this.addCartEvents(), this.addItemEvents()
        }
        bindContextOfThis() {
            this.onCartItemInput = this.onCartItemInput.bind(this), this.onCartItemClick = this.onCartItemClick.bind(this), this.updateCartNote = this.updateCartNote.bind(this)
        }
        getItemElements() {
            return {
        ...
        onCartItemClick(t) {
            ...
            t.target === e && (t.preventDefault(), t.target.disabled = !0, this.removeItem(t))
        }
        updateQuantity(t, e) {
            const n = e.dataset.cartItem,
                ...
                o = r.value || 1,
                a = parseInt(o, 10);
            return this.removeLineItemError(e), L(n, {
                quantity: a
            }).then(t => {
                return this.renderCart(t, i), theme.cartQuantity.updateQuantityInputElements(n, a), t.item_count ? this.renderCartItems(t) : (this.renderEmptyCart(), !1)
            }).then(t => {
                if (t) {
        ...
        removeItem(t) {
            ...
            return L(n, {
                ...
                if (this.renderCart(t, i), theme.cartQuantity.updateQuantityInputElements(n, 0), !t.item_count) return void this.renderEmptyCart();
                this.renderCartItems(), this.elements.closeButton = this.elements.closeButton || this.elements.cart.querySelector(j.closeButton), this.elements.closeButton.focus()
            })
        }
        updateLineItemError(t, e) {
            let n = theme.strings.quantityError;
            n = n.replace("[quantity]", e.quantity).replace("[title]", e.title), t.innerHTML = n, t.classList.add(V.hasError)
        }
        ...
        changeCheckoutButtonState(t) {
            this.elements.checkoutButton = this.elements.checkoutButton || this.elements.cart.querySelector(j.checkoutButton), this.elements.checkoutButton.disabled = t
        }
        onCartUpdated(t) {
            return this.renderCartItems(), C().then(e => {
                this.renderCart(e, t)
            })
        }
        renderCartItems(t) {
            return fetch(`${theme.rootUrl}?section_id=cart-items`).then(t => {
                ...
                return this.elements.cartItemsWrapper = this.elements.cartItemsWrapper || this.elements.cart.querySelector(j.cartItemsWrapper), this.elements.cartItemsWrapper.innerHTML = e, Object.assign(this.elements, this.getItemElements()), this.addItemEvents(), t
            })
        }
        renderCart(t, e) {
            this.renderSubtotalPrice(t.total_price), this.renderCartCountBubble(t.item_count), this.renderPriceLiveRegion(t), this.renderCartLevelDiscounts(), theme.cartQuantity.updateLocalCartState(t, e), t.item_count && (this.elements.cart.classList.remove(V.isEmpty), this.changeCheckoutButtonState(!1))
        }
        renderEmptyCart() {
            this.elements.cart.classList.add(V.isEmpty), this.changeCheckoutButtonState(!0), this.elements.cartEmptyText = this.elements.cartEmptyText || this.elements.cart.querySelector(j.emptyText), this.elements.cartEmptyText.setAttribute("tabindex", "-1"), this.elements.cartEmptyText.focus()
        }
        renderCartLevelDiscounts() {
            return fetch(`${theme.rootUrl}?section_id=cart-discounts`).then(t => {
                return t.text()
            }).then(t => {
                this.elements.discounts = this.elements.discounts || this.elements.cart.querySelector(j.discounts), this.elements.discounts.innerHTML = t
            })
        }
        renderSubtotalPrice(t) {
            const e = U(t, theme.moneyFormat);
            this.elements.cartPrice = this.elements.cartPrice || document.body.querySelectorAll(j.cartPrice), this.elements.cartPrice.forEach(t => {
                t.innerHTML = e
            })
        }
        renderCartCountBubble(t) {
            const e = document.querySelectorAll(j.cartCountBubble);
            document.querySelectorAll(j.cartCount).forEach(e => e.innerText = t > 99 ? "99+" : t), e.forEach(e => e.classList.toggle(V.hidden, 0 === t))
        }
        renderPriceLiveRegion(t) {
            ...
            this.elements.priceLiveRegion.textContent = n, this.elements.priceLiveRegion.setAttribute("aria-hidden", !1), window.setTimeout(() => {
    ...
    class J {
        ...
        updateLocalCartState(t, e) {
            t ? (this.cartState = this._convertToLocalCartState(t), this.updateQuantityIndicatorElements([e])) : C().then(t => {
                this.cartState = this._convertToLocalCartState(t), this.updateQuantityIndicatorElements()
            })
        }
        updateQuantityInputElements(t, e) {
            document.querySelectorAll(G.quantityInputKey(t)).forEach(t => {
                t.dataset.quantityInCart = e, t.value = e, e || t.dispatchEvent(new window.CustomEvent("removedFromCart"))
            })
        }
        ...
        _convertToLocalCartState(t) {
            ...
            return t.items.forEach(t => {
                e[t.product_id] || (e[t.product_id] = 0), e[t.product_id] += t.quantity
            }), e
        }
        _setQuantityIndicator(t, e) {
            const n = t.querySelector(G.quantityNumber),
                ...
                s = e ? e : 0;
            if (i !== s) {
                t.classList.contains(z.isVisible) && e ? this._animateUpdate(t) : this._animateShowOrHide(t, s), n.dataset.quantity = s;
                const i = s < 100 ? s : "99+";
                n.textContent = i;
        ...
        _animateShowOrHide(t, e) {
            if (t.classList.toggle(z.inCart, e), e) return void t.classList.add(z.isVisible);
            s(t).then(() => {
                t.classList.remove(z.isVisible)
            })
        }
        _animateUpdate(t) {
            t.classList.add(z.updated), s(t).then(() => {
    ...
    class $ {
        ...
        _focusFormStatus(t) {
            ...
            e && (e.focus(), e.addEventListener("blur", () => {
    ...
    class st {
        ...
        init() {
            this.wrapper = this.container.querySelector(et.wrapper), this.wrapper && (this.initialized = !0, this.menu = this.wrapper.querySelector(et.menu), this.arrows = this.container.querySelectorAll(et.arrow), this.isTransitioning = !1, this._setupEventHandlers(), i().then(() => {
        ...
        makeElementVisible(t) {
            if ("none" !== this.overflowValue && this.initialized) {
                ...
                if (this.wrapperRect || this._recalculateOverflow(), r > this.wrapperRect.right ? (this.direction = "next", e = !1) : s < this.wrapperRect.left && (this.direction = "previous", e = !1), !e && !this.isTransitioning) {
        ...
        destroy() {
            this.initialized && (this.wrapper.removeEventListener("scroll", this.eventHandlers.recalculateOverflow, {
                passive: !0
            }), window.removeEventListener("resize", this.eventHandlers.debounceScroller), this.arrows.forEach(t => {
        ...
        _setupEventHandlers() {
            this.eventHandlers = this._getEventHandlers(), this.wrapper.addEventListener("scroll", this.eventHandlers.recalculateOverflow, {
                passive: !0
            }), window.addEventListener("resize", this.eventHandlers.debounceScroller), this.arrows.forEach(t => {
        ...
        _getSelectorsDomRect() {
            this.wrapperRect = this.wrapper.getBoundingClientRect(), this.menuRect = this.menu.getBoundingClientRect()
        }
        _setOverflowClass(t) {
            this.overflowValue !== t && (this.wrapper.classList.remove(`${nt.wrapper}--${this.overflowValue}`), window.requestAnimationFrame(() => {
                this.wrapper.classList.add(`${nt.wrapper}--${t}`), this.overflowValue = t
            }))
        }
        _onArrowClick(t) {
            if (!this.isTransitioning) {
                this.isTransitioning = !0, this.direction = t.currentTarget.dataset.scrollerArrowDirection;
                const e = it.offset;
        ...
        _setMenuTranslateX(t) {
            ...
            this.menu.style.transform = `translateX(${e}px)`, this.translatedValue = e, this.menu.classList.remove(nt.noTransition), s(this.menu).then(() => {
                this._setWrapperScrollLeft(), this.isTransitioning = !1
            })
        }
        _setWrapperScrollLeft() {
            const t = Math.abs(this.translatedValue);
            this.menu.style.transform = "none", this.menu.classList.add(nt.noTransition), "previous" === this.direction ? this.wrapper.scrollLeft -= t : this.wrapper.scrollLeft += t
        }
    }
    const rt = {
    ...
    class at {
        constructor(t) {
            this.disclosureForm = t, this.disclosure = t.querySelector(rt.disclosure), this.disclosureList = t.querySelector(rt.disclosureList), this.disclosureToggle = t.querySelector(rt.disclosureToggle), this.disclosureInput = t.querySelector(rt.disclosureInput), this.disclosureOptions = t.querySelectorAll(rt.disclosureOptions), this._setupListeners()
        }
        destroy() {
            this.disclosureToggle.removeEventListener("click", this.eventHandlers.toggleList), this.disclosureOptions.forEach(t => t.removeEventListener("click", this.eventHandlers.connectOptions)), this.disclosure.removeEventListener("keyup", this.eventHandlers.onDisclosureKeyUp), this.disclosureList.removeEventListener("focusout", this.eventHandlers.onDisclosureListFocusOut), this.disclosureToggle.removeEventListener("focusout", this.eventHandlers.onDisclosureToggleFocusOut), document.body.removeEventListener("click", this.eventHandlers.onBodyClick)
        }
        _setupListeners() {
            this.eventHandlers = this._setupEventHandlers(), this.disclosureToggle.addEventListener("click", this.eventHandlers.toggleList), this.disclosureOptions.forEach(t => {
                t.addEventListener("click", this.eventHandlers.connectOptions)
            }), this.disclosure.addEventListener("keyup", this.eventHandlers.onDisclosureKeyUp), this.disclosureList.addEventListener("focusout", this.eventHandlers.onDisclosureListFocusOut), this.disclosureToggle.addEventListener("focusout", this.eventHandlers.onDisclosureToggleFocusOut), document.body.addEventListener("click", this.eventHandlers.onBodyClick)
        }
        _setupEventHandlers() {
            return {
        ...
        _onDisclosureKeyUp(t) {
            t.key.toLowerCase() === D.ESC && (this._toggleList(), this.disclosureToggle.focus())
        }
        _onBodyClick(t) {
        ...
        _toggleList() {
            ...
            this.disclosureList.classList.toggle(ot.listVisible), this.disclosureToggle.setAttribute("aria-expanded", !t)
        }
    }
    const ct = {
    ...
    t.register("header", {
        ...
        _setupEventHandlers() {
            this.eventHandlers = this._getEventHandlers(), a() && (window.addEventListener("scroll", this.eventHandlers.toggleHeaderSticky, {
                passive: !0
            }), document.addEventListener("productAddedToCart", this.eventHandlers.productAddedToCart), document.addEventListener("featuredCollectionTabClicked", this.eventHandlers.preventHeaderSlideIn), document.addEventListener("elementSticky", this.eventHandlers.featuredCollectionSticky)), this.elements.menuNavigation && (this.elements.dropdownParents.forEach(t => t.addEventListener("click", this.eventHandlers.onDropdownParentClick)), window.addEventListener("resize", this.eventHandlers.onWindowResize), this.elements.mobileNavigationToggle.addEventListener("click", this.eventHandlers.handleMobileNavigation))
        },
        _getEventHandlers() {
            return {
        ...
        _onWindowResize() {
            ...
            this.scrolledPastHeader || (this._handleMenuNavigationWidth(), this.drawerMenuIsActive && t ? this._closeActiveDropdown() : !this.drawerMenuIsActive && t ? this.elements.menuNavigation.style.overflow = "initial" : e && !this.drawerMenuIsActive ? this._closeMobileNavigation() : e && this.drawerMenuIsActive && this._toggleHeaderIcons(!0))
        },
        _handleMenuNavigationWidth() {
            if (!this.mqlLarge.matches) return void(this.drawerMenuIsActive = !0);
            this.elements.menuNavigation.style.overflow = "hidden", this.elements.menuNavigation.getBoundingClientRect().right >= this.elements.menuNavigation.querySelector(dt.menuNavigationLastItem).getBoundingClientRect().right ? (this.elements.menuNavigation.classList.remove(lt.menuNavigationHidden), this.drawerMenuIsActive = !1) : (this.elements.menuNavigation.classList.add(lt.menuNavigationHidden), this.drawerMenuIsActive = !0)
        },
        ...
        _onDropdownParentClick(t) {
            const e = t.currentTarget;
            "main" === e.dataset.dropdownParentType && e.closest(dt.menuNavigationType("desktop")) && (t.stopImmediatePropagation(), this._onBodyClick());
        ...
        _setupMainLevelDropdown(t) {
            ...
            t.dataset.width = `${width}px`, t.style.width = width < 260 ? `${width}px` : "26rem", t.style.removeProperty("white-space"), t.dataset.maxHeight = width < 260 ? `${height}px` : `${t.getBoundingClientRect().height}px`, t.style.maxHeight = "0px"
        },
        _setupChildAndMobileDropdown(t) {
            t.dataset.maxHeight = `${t.getBoundingClientRect().height}px`, t.style.maxHeight = "0px"
        },
        ...
        _animateDropdownClosed(t, e, n = !0) {
            ...
            i ? (e.classList.remove(lt.menuNavigationItemIsExpanded), t.closest(dt.menuNavigationType("desktop")) && t.removeEventListener("focusout", this.eventHandlers.onDropdownFocusOut)) : e.classList.remove(lt.menuDropdownItemIsExpanded), t.style.maxHeight = "0px", t.style.opacity = 0, n ? s(t).then(() => {
                this._closeDropdown(e, t, i)
            }) : this._closeDropdown(e, t, i)
        },
        _closeDropdown(t, e, n) {
            t.setAttribute("aria-expanded", "false"), n && e.closest(dt.menuNavigationType("desktop")) && (this._getDesktopActiveParentDropdown() || (this.elements.menuNavigation.style.overflow = "hidden"), document.body.removeEventListener("click", this.eventHandlers.onBodyClick), e.removeEventListener("click", this._preventDropdownClick), t.parentNode.removeEventListener("keyup", this.eventHandlers.onDropdownKeyup))
        },
        _animateDropdownOpen(t, e) {
            const n = "main" === e.dataset.dropdownParentType,
                i = e.closest(dt.menuNavigationType("desktop"));
            n ? (i && (this.elements.menuNavigation.style.overflow = "initial"), e.classList.add(lt.menuNavigationItemIsExpanded), i && t.addEventListener("focusout", this.eventHandlers.onDropdownFocusOut)) : e.classList.add(lt.menuDropdownItemIsExpanded), e.setAttribute("aria-expanded", "true"),
                t.style.maxHeight = `${t.dataset.maxHeight}`, t.style.opacity = 1, i && n && s(t).then(() => {
                    document.body.addEventListener("click", this.eventHandlers.onBodyClick), t.addEventListener("click", this._preventDropdownClick), e.parentNode.addEventListener("keyup", this.eventHandlers.onDropdownKeyup)
                })
        },
        _onDropdownKeyup(t) {
        ...
        _handleMobileNavigation(t) {
            const e = t.currentTarget;
            "true" === e.getAttribute("aria-expanded") ? this._closeMobileNavigation() : (this._openMobileNavigation(e), this.stickyHeaderTimeout && clearTimeout(this.stickyHeaderTimeout), this.lastScrollDirection = "none")
        },
        _closeMobileNavigation() {
            this._toggleHeaderIcons(), this.elements.headerButtons.length && this.elements.headerButtons.forEach(t => t.removeEventListener("click", this.eventHandlers.handleMultiplePopups)), document.removeEventListener("keyup", this.eventHandlers.onDrawerNavigationKeyup), document.removeEventListener("focusin", this._onBodyFocusIn), this.elements.drawerNavigationPopup.closePopup(!1)
        },
        _openMobileNavigation(t) {
            this.elements.drawerNavigationPopup = this.elements.drawerNavigationPopup || window.popups.find(t => t.name === ht.menuNavigation), this.elements.headerButtons = this.elements.headerButtons || this.elements.headerIcons.filter(t => t.hasAttribute(ut.popupOpen)), this._setupMobileNavigationDropdowns(), this._setMobileDrawerHeight(), this._toggleHeaderIcons(!0), this.elements.headerButtons.length && this.elements.headerButtons.forEach(t => t.addEventListener("click", this.eventHandlers.handleMultiplePopups)), document.addEventListener("keyup", this.eventHandlers.onDrawerNavigationKeyup), document.addEventListener("focusin", this._onBodyFocusIn), this.elements.drawerNavigationPopup.openPopup({
                currentTarget: t
            })
        },
        _onBodyFocusIn(t) {
        ...
        _setMobileDrawerHeight() {
            this.elements.mobileNavigationContainer = this.elements.mobileNavigationContainer || this.elements.headerWrapper.querySelector(dt.mobileNavigationContainer), this.elements.mobileNavigationDrawer = this.elements.mobileNavigationDrawer || this.elements.headerWrapper.querySelector(dt.mobileNavigationDrawer);
            const t = this.elements.headerWrapper.getBoundingClientRect().height,
                e = window.pageYOffset,
                n = t - e;
            this.elements.mobileNavigationDrawer.style.top = `${t}px`, this.elements.mobileNavigationContainer.style.height = `calc(100vh - ${n}px)`
        },
        ...
        _onDrawerNavigationKeyup(t) {
            t.key.toLowerCase() === D.ESC && (this._toggleHeaderIcons(), document.removeEventListener("keyup", this.eventHandlers.onDrawerNavigationKeyup))
        },
        // _prepareStickyHeader() {
        //     this.featuredCollections = {}, this.previousScrollPosition = window.pageYOffset, this.headerWrapperHeight = this.elements.headerWrapper.offsetHeight, this.originalHeaderHeight = this.elements.header.offsetHeight, this._setupHeaderObserver(), this.headerObserver.observe(this.elements.headerSentinel), this.elements.headerWrapper.style.position = "fixed", document.querySelector(dt.mainContent).style.paddingTop = `${this.headerWrapperHeight}px`
        // },
        // _setupHeaderObserver() {
        //     this.headerObserver = new IntersectionObserver(t => {
        //         if (t[0].isIntersecting) {
        //             if (this._resetSentinel(), this.scrolledPastHeader = !1, this._toggleInlineMenuOpacity(), void 0 === this.isFixed) return;
        //             requestAnimationFrame(() => {
        //                 this._resetHeader()
        //             })
        //         } else this.scrolledPastHeader = !0, this.isFixed = !1, this._headerSlideOut(), s(this.elements.headerWrapper).then(() => {
        //             this._toggleInlineMenuOpacity(), this.drawerMenuIsActive = !0
        //         }), this.elements.headerWrapper.classList.add(lt.headerWrapperHidden), this._moveSentinel()
        //     })
        // },
        ...
        //         if (this.previousScrollPosition = t, this.scrolledPastHeader && this.lastScrollDirection !== e)
        //             if (this.lastScrollDirection = e, "down" === e) this.elements.menuNavigation && this._closeActiveDropdown(), this.isFixed ? requestAnimationFrame(() => {
        //                 this._headerSlideOut()
        //             }) : (this.elements.headerLogo && this.elements.headerLogo.style.removeProperty("transition"), requestAnimationFrame(() => {
        ...
        _productAddedToCart() {
            if (this.scrolledPastHeader) {
                if (!this.isFixed) {
                    if (this.isHeaderAnimating) return void setTimeout(() => {
                        this._headerSlideIn()
                    }, 500);
                    this._headerSlideIn()
                }
                clearTimeout(this.stickyHeaderTimeout), this.stickyHeaderTimeout = setTimeout(() => {
                    this._headerSlideOut()
                }, 5e3)
            }
        },
        _preventHeaderSlideIn() {
            this.doNotSlideHeaderIn = !0, this.isFixed && this._headerSlideOut(), this.lastScrollDirection = null, this.preventHeaderSlideInTimeout = setTimeout(() => {
                this.doNotSlideHeaderIn = !1, this.previousScrollPosition = window.pageYOffset
            })
        },
        _featuredCollectionSticky(t) {
            const {
                ...
                isSticky: isSticky,
                container: container
            } = t.detail, e = container.dataset.sectionId;
            this.featuredCollections[e] = this.featuredCollections[e] || {
                stickyElement: stickyElement,
                isSticky: isSticky
            }, this.featuredCollections[e].isSticky = isSticky, this._toggleFeaturedCollectionStyle(this.featuredCollections[e])
        },
        // _resetHeader() {
        //     this.elements.headerSentinel && (this.isFixed = !1, this.isHeaderAnimating = !0, this._clearStickyHeaderTimeout(), this.elements.menuNavigation && (this.elements.headerLogo ? s(this.elements.headerLogo).then(() => {
        //         this._handleMenuNavigationWidth()
        //     }) : this._handleMenuNavigationWidth()), this._toggleBodyClass(), this.elements.announcementBar && (this.elements.announcementBar.style.display = "block"), this.elements.headerWrapper.classList.remove(lt.headerWrapperFixed, lt.headerWrapperHidden), this.featuredCollections && (Object.keys(this.featuredCollections).forEach(t => {
        //         const e = this.featuredCollections[t];
        //         e.stickyElement.style.transform = "translateY(0)", e.stickyElement.style.removeProperty("transition")
        //     }), this.isHeaderAnimating = !1))
        // },
        // _headerSlideIn() {
        //     this.isFixed = !0, this.isHeaderAnimating = !0, this.drawerMenuIsActive = !0, this._toggleBodyClass(), this.elements.announcementBar && (this.elements.announcementBar.style.display = "none"), requestAnimationFrame(() => {
        //         this.elements.headerWrapper.classList.add(lt.headerWrapperFixed), this.elements.headerWrapper.classList.remove(lt.headerWrapperHidden), this._checkForFeaturedCollection()
        //     }), s(this.elements.headerWrapper).then(() => {
        //         this.elements.headerLogo && (this.elements.headerLogo.style.transition = "max-width 0.25s ease-out"), this.isHeaderAnimating = !1
        //     })
        // },
        // _headerSlideOut() {
        //     this.isFixed = !1, this.isHeaderAnimating = !0, this._toggleBodyClass(), this.elements.headerLogo && this.elements.headerLogo.style.removeProperty("transition"), this.elements.headerWrapper.classList.add(lt.headerWrapperHidden), s(this.elements.headerWrapper).then(() => {
        //         this.elements.headerWrapper.classList.remove(lt.headerWrapperFixed), this.isHeaderAnimating = !1
        //     }), this._checkForFeaturedCollection(), this._clearStickyHeaderTimeout()
        // },
        // _moveSentinel() {
        ...
        _toggleFeaturedCollectionStyle(t) {
            this.isFixed && t.isSticky ? (t.stickyElement.style.transition = "transform .25s ease-out", t.stickyElement.style.transform = `translateY(${this.elements.header.offsetHeight}px)`) : (t.stickyElement.style.transform = "translateY(0)", s(t.stickyElement).then(() => {
    ...
    class ft {
        ...
        init() {
            Object.assign(this.elements, this.getElements()), this.eventHandlers = this.setupEventHandlers(), this.bindEvents(), this.state = this.setInitialState(), this.setIndicatorLabel(), this.hideMedia(), this.applyTransformation(), window.setTimeout(() => this.enableTransition()), this.preloadAdjacentImages()
        }
        getElements() {
            return {
        ...
        bindEvents() {
            [this.elements.arrowNext, this.elements.arrowPrev].forEach(t => {
                t.addEventListener("click", this.eventHandlers.onArrowClick)
            }), this.elements.container.addEventListener("keyup", this.eventHandlers.onKeyUp), this.navigationOnClick && this.elements.images.forEach(t => {
        ...
        destroy() {
            [this.elements.arrowNext, this.elements.arrowPrev].forEach(t => {
                t.removeEventListener("click", this.eventHandlers.onArrowClick)
            }), this.elements.container.removeEventListener("keyup", this.eventHandlers.onKeyUp), this.elements.images.forEach(t => {
        ...
        onArrowClick(t) {
            t.preventDefault(), this.state.isNext = "mediaArrowNext" in t.currentTarget.dataset, this.goToAdjacentMedia()
        }
        onKeyUp(t) {
            t.key.toLowerCase() !== D.LEFT && t.key.toLowerCase() !== D.RIGHT || (t.preventDefault(), this.state.isNext = t.key.toLowerCase() === D.RIGHT, this.goToAdjacentMedia())
        }
        onImageClick(t) {
        ...
        goToAdjacentMedia() {
            this.setMediaIndex(), this.setActiveMedia("mediaIndex"), this.state.mediaId = Number(this.state.activeMediaImage.dataset.mediaId), this.renderGallery()
        }
        variantMediaSwitch(t) {
            t !== this.state.mediaId && (this.state.mediaId = t, this.setActiveMedia("mediaId"), this.state.mediaIndex = Number(this.state.activeMediaImage.dataset.mediaIndex), this.renderGallery())
        }
        cacheElement(t) {
        ...
        applyActiveClass() {
            this.state.activeMediaImage.classList.add(pt.isActive), this.loadImage(this.state.activeMediaImage)
        }
        hideMedia() {
            this.state.useAriaHidden && this.elements.images.forEach(t => {
                const e = t.closest(mt.mediaWrapper),
                    n = e.querySelectorAll("button, a");
                if (!t.classList.contains(pt.isActive)) return t.closest(mt.mediaWrapper).setAttribute("aria-hidden", "true"), void n.forEach(t => t.setAttribute("tabindex", "-1"));
                e.removeAttribute("aria-hidden"), n.forEach(t => t.removeAttribute("tabindex"))
            })
        }
        getIndicatorText() {
        ...
        updateLiveRegion() {
            const t = this.getIndicatorText();
            this.elements.liveRegionContent.setAttribute("aria-hidden", !1), this.elements.liveRegionContent.textContent = t, setTimeout(() => {
                this.elements.liveRegionContent.setAttribute("aria-hidden", !0)
            }, 2e3)
        }
        loadImage(t) {
            t.getAttribute("src") || "IMG" !== t.tagName || t.setAttribute("src", t.dataset.src), t.getAttribute("srcset") || "IMG" !== t.tagName || t.setAttribute("srcset", t.dataset.srcset)
        }
        clearActiveClasses() {
        ...
        enableTransition() {
            this.cacheElement("strip"), this.elements.strip.classList.add(pt.transitionReady)
        }
        applyTransformation() {
        ...
        resetTransformation() {
            this.cacheElement("strip"), this.elements.strip.classList.remove(pt.transitionReady), this.elements.strip.style.transform = `translateX(0)`
        }
        addAccessibilityAttr() {
            this.elements.container.setAttribute("aria-roledescription", theme.strings.mediaCarousel), this.elements.container.setAttribute("aria-label", this.elements.container.dataset.label), this.elements.mediaStripWrapper.setAttribute("aria-live", "polite"), this.elements.mediaWrapper.forEach(t => {
                t.setAttribute("role", "group"), t.setAttribute("aria-roledescription", theme.strings.mediaSlide), t.setAttribute("aria-label", t.dataset.mediaLabel)
            })
        }
        removeAccessibilityAttr() {
            this.elements.container.removeAttribute("aria-roledescription"), this.elements.container.removeAttribute("aria-label"), this.elements.mediaWrapper.forEach(t => {
                t.removeAttribute("aria-roledescription"), t.removeAttribute("aria-label"), t.removeAttribute("role")
        ...
        renderGallery() {
            this.clearActiveClasses(), this.applyActiveClass(), this.hideMedia(), this.applyTransformation(), this.renderCurrentIndex(), this.setIndicatorLabel(), this.updateLiveRegion(), this.preloadAdjacentImages()
        }
    }
    ...
    x.prototype.destroy = function () {
        ...
        e || (e = document.createElement("input"), e.type = "hidden", e.name = "id", this.element.appendChild(e)), e.value = t.toString()
    ...
    const yt = {
            ...
            drawerVariantTitleWrapper: "[data-store-availability-drawer-variant-title-wrapper]",
    ...
    class wt {
        constructor(t, e) {
            this.container = t, this.errorTemplate = t.querySelector(yt.errorTemplate), this.productTitle = this.container.getAttribute("data-product-title"), this.hasOnlyDefaultVariant = "true" === this.container.getAttribute("data-has-only-default-variant"), this.options = {
                variant: null,
                variantLabels: []
            }, Object.assign(this.options, e), this._bindEvents()
        }
        hide() {
        ...
        updateContent(t, e) {
            const n = `${this.container.getAttribute("data-base-url")}/variants/${t}?section_id=store-availability`;
            this.variantOptions = e, fetch(n).then(t => {
                return t.text()
            }).then(t => {
                this._render(t)
            }).catch(() => {
        ...
        _onClickContainer(t) {
            ...
            e && this.options.variant.available && this.updateContent(this.options.id, this.options.options);
        ...
        _updateDrawer(t) {
            const e = document.createDocumentFragment(),
                ...
                i = n.elements.popup;
            this.drawerOutput = i.querySelector(yt.drawerOutput), this.drawerProductTitle = i.querySelector(yt.drawerProductTitle), this.drawerVariantTitleWrapper = i.querySelector(yt.drawerVariantTitleWrapper), this.hasOnlyDefaultVariant && this._hideVariantTitle(), this.drawerProductTitle.textContent = this.productTitle, this.options.variantLabels.length > 0 && this.variantOptions.forEach((t, n) => {
                const i = e.appendChild(document.createElement("div")),
                    s = i.appendChild(document.createElement("span"));
                s.textContent = this.options.variantLabels[n], s.className = "store-availability-variant__label", i.appendChild(document.createElement("span")).textContent = t
            }), this.drawerVariantTitleWrapper.innerHTML = "", this.drawerVariantTitleWrapper.appendChild(e), this.drawerOutput.innerHTML = "", this.drawerOutput.appendChild(t)
        }
    }
    const bt = {
    ...
    class St {
        ...
        init() {
            if (this.eventHandlers = {}, Object.assign(this.elements, this._getElements()), this.elements.productForm)
                if (this.productId = this.elements.productForm.dataset.productId, this.elements.productJSON) {
                    const t = JSON.parse(this.elements.productJSON.innerHTML);
                    if (this._initProductForm(t), this.elements.storeAvailability && this.productForm) {
                ...
                } else this._getProductJSON(this.elements.productForm.dataset.productHandle).then(t => {
        ...
        destroy() {
            ...
            }), this.hasInstantQuantity && (this.elements.quantityInput.removeEventListener("input", this.eventHandlers.onQuantityInputTextChanged), this.elements.quantityInput.removeEventListener("removedFromCart", this.eventHandlers.onProductRemovedFromCart)))
        }
        _hideInstantQuantity() {
            this.hasInstantQuantity && this.elements.quantityInputWrapper && (this.elements.quantityInput.value = 1, this._hideErrorMessage(), this.elements.quantityInputWrapper.classList.add(Et.hidden), this.elements.addToCart.classList.remove(Et.hidden), this.elements.addToCart.focus())
        }
        _initProductForm(t) {
        ...
        _getElements() {
            return {
                ...
                errorMessageWrapper: this.elements.container.querySelector(Ct.errorMessageWrapper),
                errorMessageElement: this.elements.container.querySelector(Ct.errorMessage),
                masterSelect: this.elements.container.querySelector(Ct.productMasterSelect),
                ...
                productPolicies: this.elements.container.querySelector(Ct.productPolicies),
                ...
                successMessage: this.elements.container.querySelector(Ct.productSuccessMessage),
                quantityInputWrapper: this.elements.container.querySelector(Ct.quantityInputWrapper),
                quantityInput: this.elements.container.querySelector(Ct.quantityInput),
                quantitySelectors: this.elements.container.querySelectorAll(Ct.quantitySelectors),
                quantitySelectorIncrease: this.elements.container.querySelector(Ct.quantitySelectorIncrease),
                unitPrice: this.elements.container.querySelector(Ct.unitPrice),
                unitPriceBaseUnit: this.elements.container.querySelector(Ct.unitPriceBaseUnit),
                storeAvailability: this.elements.container.querySelector(Ct.storeAvailability)
            }
        }
        _getEventHandlers() {
            return {
        ...
        _setupEventListeners() {
            this.elements.container.dataset.showQuantitySelector && (this.eventHandlers = this._getEventHandlers(), this.hasInstantQuantity = Boolean(this.elements.quantityInputWrapper.dataset.quantityInputInstant), this.elements.quantitySelectors.forEach(t => {
                t.addEventListener("click", this.eventHandlers.onQuantitySelectorClick)
            }), this.hasInstantQuantity && (this.elements.quantityInput.addEventListener("input", this.eventHandlers.onQuantityInputTextChanged), this.elements.quantityInput.addEventListener("removedFromCart", this.eventHandlers.onProductRemovedFromCart)))
        }
        _getProductJSON(t) {
        ...
        _onFormSubmit(t) {
            t.preventDefault(), this.elements.container.querySelector(Ct.addToCart).hasAttribute("aria-disabled") || this._quantityIsInvalid() || this._addItemToCart()
        }
        _quantityIsInvalid() {
            return !(!this.elements.quantityInput || !(parseInt(this.elements.quantityInput.value, 10) <= 0 || "" === this.elements.quantityInput.value)) && (this._showErrorMessage(theme.strings.quantityMinimumMessage), !0)
        }
        _showInstantQuantity(t) {
            this.hasInstantQuantity && this.elements.quantityInputWrapper && (this.elements.quantityInput.dataset.quantityInputKey = t.key, this.elements.quantityInput.value = t.quantity, this.elements.addToCart.classList.add(Et.hidden), this.elements.quantityInputWrapper.classList.remove(Et.hidden), this.elements.quantityInput && this.elements.quantityInput.focus())
        }
        _addItemToCart() {
            this._hideErrorMessage(), this._toggleSuccessMessage(!0), S(this.elements.productForm).then(t => {
                this._toggleSuccessMessage(!1, this._getSuccessMessage()), this._showInstantQuantity(t), window.carts.length || this._onCartUpdated(), this.isUpdatingCart = !1, document.dispatchEvent(new CustomEvent("productAddedToCart")), window.carts.forEach(t => {
        ...
        _toggleSuccessMessage(t, e = "") {
            this.elements.successMessage && (this.elements.successMessage.textContent = e, this.elements.successMessage.classList.toggle(Et.hidden, t))
        }
        _onCartUpdated() {
            C().then(t => {
                this._updateCartPriceBubble(t.total_price), this._updateCartCountBubble(t.item_count), theme.cartQuantity.updateLocalCartState(t, this.productId)
            }).catch(t => {
                throw new Error(t)
            })
        }
        ...
        _updateCartCountBubble(t) {
            this.cartCountBubbles = this.cartCountBubbles || document.querySelectorAll(Ct.cartCountBubble), this.cartCounts = this.cartCounts || document.querySelectorAll(Ct.cartCount), this.cartCounts.forEach(e => e.innerText = t > 99 ? "99+" : t), this.cartCountBubbles.forEach(e => e.classList.toggle(Et.hidden, 0 === t))
        }
        ...
        _showErrorMessage(t) {
            this.elements.errorMessageElement && this.elements.errorMessageWrapper && (this.elements.errorMessageElement.innerHTML = t, this.elements.errorMessageWrapper.classList.remove(Et.hidden), this.elements.errorMessageWrapper.setAttribute("aria-hidden", !0), this.elements.errorMessageWrapper.removeAttribute("aria-hidden"), this.elements.quantityInputWrapper && !this.hasInstantQuantity && this.elements.quantityInputWrapper.classList.add(Et.formInputError))
        }
        _hideErrorMessage() {
            this.elements.errorMessageWrapper && (this.elements.errorMessageWrapper.classList.add(Et.hidden), this.elements.quantityInputWrapper && !this.hasInstantQuantity && this.elements.quantityInputWrapper.classList.remove(Et.formInputError))
        }
        _onFormOptionChange(t) {
            const e = t.dataset.variant;
            this._updateMasterSelect(e), this._hideErrorMessage(), this._toggleSuccessMessage(!0), this._updatePrice(e), this._updateProductPolicies(e), this._updateAddToCart(e), this._updateVariantName(e), this._hideInstantQuantity(), this._updateStoreAvailability(e);
            const n = this._getVariantUpdatedText(e);
            this._updateLiveRegion(n), this._fireEvent("formOptionChanged", {
                variant: e
            })
        }
        _fireEvent(t, e) {
        ...
        _onQuantitySelectorClick(t) {
            if (!this.isUpdatingCart) {
                ...
                n.value = s, this.hasInstantQuantity && (clearTimeout(this.timeout), this.timeout = setTimeout(() => {
        ...
        _updateCartQuantity() {
            ...
            if (t) {
                const [e] = t.split(":"), n = parseInt(this.elements.quantityInput.value, 10);
                L(t, {
                    quantity: n
                }).then(i => {
                    this.isUpdatingCart = !1,
                        window.carts.length || this._onCartUpdated(), window.carts.forEach(t => {
                            t.onCartUpdated(this.productId)
                        }), theme.cartQuantity.updateQuantityInputElements(t, n);
                    const s = this._getQuantityUpdatedText(n);
                    this._updateLiveRegion(s), document.dispatchEvent(new CustomEvent("productAddedToCart"));
                    const r = i.items.find(e => e.key === t),
                        o = i.items.reduce((t, n) => {
                            return n.id === Number(e) ? t + n.quantity : t
                        }, 0);
                    n > o && (this.elements.quantityInput.value = o, this.elements.quantityInput.focus(), this._showErrorMessage(this._getQuantityErrorMessage(r))), n || this._hideInstantQuantity()
                })
            }
        }
        _updatePrice(t) {
            if (this.elements.priceContainer) {
                if (this.elements.priceContainer.classList.remove(Et.productUnavailable, Et.productOnSale, Et.productUnitAvailable, Et.productSoldOut), this.elements.priceContainer.removeAttribute("aria-hidden"), !t) return this.elements.priceContainer.classList.add(Et.productUnavailable), void this.elements.priceContainer.setAttribute("aria-hidden", !0);
                t.available || this.elements.priceContainer.classList.add(Et.productSoldOut), t.compare_at_price > t.price ? this._renderOnSalePrice(t) : this._renderRegularPrice(t), this._updateUnitPrice(t)
            }
        }
        _renderOnSalePrice(t) {
            this.elements.regularPrice.forEach(e => {
                e.innerHTML = this._formatMoney(t.compare_at_price)
            }), this.elements.salePrice && (this.elements.salePrice.innerHTML = this._formatMoney(t.price), this.elements.priceContainer.classList.add(Et.productOnSale))
        }
        ...
        _updateUnitPrice(t) {
            t.unit_price && this.elements.unitPrice && this.elements.unitPriceBaseUnit && (this.elements.unitPrice.innerHTML = this._formatMoney(t.unit_price, theme.moneyFormat), this.elements.unitPriceBaseUnit.innerText = this._getBaseUnit(t), this.elements.priceContainer.classList.add(Et.productUnitAvailable))
        }
        _getBaseUnit(t) {
            return 1 === t.unit_price_measurement.reference_value ? t.unit_price_measurement.reference_unit : t.unit_price_measurement.reference_value + t.unit_price_measurement.reference_unit
        }
        _updateProductPolicies(t) {
            this.elements.productPolicies && (this.elements.productPolicies.classList.remove(Et.visuallyHidden), t || this.elements.productPolicies.classList.add(Et.visuallyHidden))
        }
        _updateAddToCart(t) {
            this.elements.addToCart && this.elements.addToCartText && (t ? t.available ? (this.elements.addToCart.removeAttribute("aria-disabled"), this.elements.addToCart.setAttribute("aria-label", theme.strings.addToCart), this.elements.addToCartText.innerText = theme.strings.addToCart) : (this.elements.addToCart.setAttribute("aria-disabled", !0), this.elements.addToCart.setAttribute("aria-label", theme.strings.soldOut), this.elements.addToCartText.innerText = theme.strings.soldOut) : (this.elements.addToCart.setAttribute("aria-disabled", !0), this.elements.addToCart.setAttribute("aria-label", theme.strings.unavailable), this.elements.addToCartText.innerText = theme.strings.unavailable))
        }
        _updateLiveRegion(t) {
            this.elements.productStatus && (this.elements.productStatus.innerText = t, this.elements.productStatus.setAttribute("aria-hidden", !1), setTimeout(() => {
        ...
        _getQuantityUpdatedText(t, e) {
            ...
            return 0 === t ? n = theme.strings.productRemovedFromCart : 1 === t && e && (n = theme.strings.productAddedToCart), n.replace("[title]", this.elements.productForm.dataset.variantName)
        }
        _getVariantUpdatedText(t) {
            ...
            let i = "",
                ...
                a = "",
                c = "";
            return e && (i = theme.strings.regularPrice, s = this._formatMoney(t.compare_at_price), r = theme.strings.salePrice, o = this._formatMoney(t.price)), t.unit_price && (a = theme.strings.unitPrice, c = `${this._formatMoney(t.unit_price)} ${theme.strings.unitPriceSeparator} ${this._getBaseUnit(t)}`), `${n} ${i} ${s} ${r} ${o} ${a} ${c}`
        }
        _updateStoreAvailability(t) {
            this.storeAvailability && (t && t.available ? (this.storeAvailability.updateContent(t.id, t.options), this.storeAvailability.updateVariant(t)) : this.storeAvailability.hide())
        }
    }
    const Lt = {
        productForm: "[data-product-form]",
    ...
    class _t {
        constructor(t) {
            this.container = t, this._prepareGallery(), this.container.querySelector(Lt.productForm) && (this._setupEventListeners(), this.productForm = new St(this.container), this.productForm.init())
        }
        destroy() {
            this.productForm && this.productForm.destroy(), this.container.removeEventListener("formOptionChanged", this.eventHandlers.onFormOptionChange), Boolean(this.gallery) && this.gallery.destroy()
        }
        _getEventHandlers() {
            return {
        ...
        _setupEventListeners() {
            this.eventHandlers = this._getEventHandlers(), this.container.addEventListener("formOptionChanged", this.eventHandlers.onFormOptionChange)
        }
        _prepareGallery() {
            if (this.galleryElement = this.container.querySelector(Lt.media), this.galleryElement) {
                if ("gallery" === this.container.dataset.mediaType) return void this._initializeGallery();
                if (this._addGalleryMediaQueryListener(), this.galleryMediaQueryListener.matches) return this._initializeGallery(), void this.gallery.addAccessibilityAttr();
                this._loadAllGalleryImages()
            }
        }
        _addGalleryMediaQueryListener() {
            this.galleryMediaQueryListener = window.matchMedia(c("large", "max")), this.galleryMediaQueryListener.addListener(t => {
        ...
        _switchToGalleryMode() {
            ...
            this.gallery.state.useAriaHidden = !0, this.gallery.hideMedia(), this.gallery.addAccessibilityAttr(), t || this.gallery.bindEvents()
        }
        _switchToStackedMode() {
            this._loadAllGalleryImages(), this.gallery.removeAccessibilityAttr(), this.gallery.resetTransformation(), this.gallery.state.useAriaHidden = !1, this.gallery.destroy()
        }
        _initializeGallery() {
            return this.gallery ? (this.gallery.applyTransformation(), window.setTimeout(() => this.gallery.enableTransition()), !1) : (this.gallery = new ft(this.galleryElement), this.gallery.init(), !0)
        }
        _loadAllGalleryImages() {
            this.container.querySelectorAll(Lt.singleMedia).forEach(t => {
                t.getAttribute("src") || t.setAttribute("src", t.getAttribute("data-src")), t.getAttribute("srcset") || t.setAttribute("srcset", t.getAttribute("data-srcset")), t.outerHTML = t.outerHTML
            }), this.gallery && (this.gallery.elements.images = Array.from(this.gallery.elements.container.querySelectorAll(Lt.singleMedia)))
        }
        _onFormOptionChange(t) {
            const e = t.detail.variant;
            if (e && e.featured_media && this.gallery && (this.gallery.variantMediaSwitch(e.featured_media.id), this.galleryMediaQueryListener)) {
    ...
    class kt {
        ...
        init() {
            this.elements.productModal = document.querySelector(Tt.productModal), this.elements.productModal && (this.eventHandlers = this._getEventHandlers())
        }
        setupProductModal(t) {
            this._getProductModalContent(t).then(t => {
                this.elements.productModal.querySelector(Tt.productCollectionTitle).textContent = this.collectionTitle, this._setupProductModalContent(t)
            }).catch(t => {
                throw new Error(t)
            })
        }
        ...
        _setupEventHandlers() {
            this.elements.productContainer.addEventListener("popup_closed", this.eventHandlers.hideProductModal), this.elements.viewCart = this.elements.productModalContent.querySelector(Tt.productViewCartLink), this.elements.viewCart && this.elements.viewCart.addEventListener("click", this.eventHandlers.hideModalShowCart)
        }
        _updateSPRReviews() {
            window.SPR && window.SPR.initDomEls && window.SPR.loadProducts && (window.SPR.initDomEls(), window.SPR.loadProducts())
        }
        ...
        _setupProductModalContent(t) {
            this.elements.productModalContent.innerHTML = "", this.elements.productModalContent.scrollTo(0, 0);
            const e = t.querySelector(Tt.productRecommendationsContainer),
                n = this._getProductSection(t);
            this.elements.productModal.classList.toggle(It.productModalNoMedia, !this._productHasMedia(t)), this.elements.productModalContent.appendChild(n), e && this._getProductRecommendations(e).then(t => {
                this.elements.productModalContent.appendChild(t), this.productRecommendations.resetSafariImages(), this.productPopup = this.productPopup || window.popups.find(t => "product-modal" === t.name), this.productPopup.resetContainerFocus()
            }).catch(t => {
                throw new Error(t)
            }), this.elements.productModalContent.querySelectorAll(Tt.productImage).forEach(t => t.outerHTML = t.outerHTML), this._showProductModal(n), this._updateSPRReviews(), this._setupEventHandlers()
        }
        _getProductSection(t) {
            return t.querySelector(Tt.productTemplate)
        }
        _getProductRecommendations(t) {
            return this.productRecommendations = new Ht(t), this.productRecommendations.init(), this.productRecommendations.setupAndGetHTML()
        }
        _productHasMedia(t) {
            return t.querySelectorAll(Tt.productImage).length
        }
        _showProductModal(t) {
            this.product = new _t(t), this.productPopup = this.productPopup || window.popups.find(t => "product-modal" === t.name), window.Shopify && Shopify.PaymentButton && Shopify.PaymentButton.init(), this.productPopup.elements.stage.classList.contains(It.isOpen) || this.productPopup.openPopup({
                currentTarget: this.elements.productContainer
            })
        }
        _hideModalShowCart(t) {
            t.preventDefault(), this.cartPopup = this.cartPopup || window.popups.find(t => "cart" === t.name), this.productPopup.closePopup(), this.cartPopup.openPopup({
                currentTarget: this.productPopup.elements.triggerNode
            }), this._hideProductModal(), this.elements.viewCart && this.elements.viewCart.removeEventListener("click", this.eventHandlers.hideModalShowCart)
        }
        _hideProductModal() {
            this.elements.productModalContent.innerHTML = "", this.elements.productModalContent.classList.remove(It.productModalContentNoMedia), this.product.destroy(), this.elements.productContainer.removeEventListener("popup_closed", this.eventHandlers.hideProductModal)
        }
    }
    const At = {
    ...
    class qt {
        ...
        init() {
            Object.assign(this.elements, this._getElements()), this._setupEventHandlers(), this.productModal = new kt(this.elements.productCard, this.elements.productModalContent, this.collectionTitle), this.productModal.init(), this.elements.productForm && (this.productForm = new St(this.elements.productCard), this.productForm.init())
        }
        _getElements() {
            return {
                productCardLinks: this.elements.productCard.querySelectorAll(At.productCardLink),
                productForm: this.elements.productCard.querySelector(At.productForm),
                showOptionsButton: this.elements.productCard.querySelector(At.showOptionsButton)
            }
        }
        _getEventHandlers() {
            return {
        ...
        _setupEventHandlers() {
            this.eventHandlers = this._getEventHandlers(), this.elements.showOptionsButton && (this.elements.showOptionsButton.addEventListener("click", () => {
        ...
        _toggleShowOptions(t) {
            if (this.elements.productCard.classList.toggle(Mt.productCardFormExpanded, t), this.elements.showOptionsButton.classList.toggle(Mt.hidden, t), t) {
    ...
    class Ht {
        constructor(t, e = !1) {
            this.elements = {
                container: t
            }, this.setupRecommendationsOnInit = e, this.recommendationsLoaded = !1, this.isProductModalEnabled = Boolean(this.elements.container.dataset.productModal), this.isQuickAddEnabled = Boolean(this.elements.container.dataset.quickAdd)
        }
        init() {
            Object.assign(this.elements, this._getElements()), this.setupRecommendationsOnInit && this._setupProductRecommendations()
        }
        setupAndGetHTML() {
            return new Promise((t, e) => {
                this._getProductRecommendationsHTML().then(n => {
                    if (this._showProductRecommendations(n, !1), this.recommendationsLoaded) t(this.elements.container);
                    else {
        ...
        resetSafariImages() {
            this.elements.container.querySelectorAll(Pt.productCardImage).forEach(t => t.outerHTML = t.outerHTML)
        }
        ...
        _showProductRecommendations(t, e = !0) {
            ...
            n && (this.elements.container.appendChild(n), this._setupProductCards(), e && this.resetSafariImages(), this.recommendationsLoaded = !0)
        }
        _getElements() {
            return {
        ...
        _setupProductCards() {
            if (theme.cartQuantity.updateQuantityIndicatorElements(!1, this.elements.container), this.isProductModalEnabled || this.isQuickAddEnabled) {
                this.elements.container.querySelectorAll(Pt.productCard).forEach(t => {
    ...
    t.register("product-recommendations", {
        onLoad() {
            this.productRecommendations = new Ht(this.container, !0), this.productRecommendations.init()
        }
    });
    const xt = {
    ...
    class Ot {
        ...
        init() {
            a() && (this.stickyElement = this.container.querySelector(xt.stickyElement), this.stickyElement && (this.sticky = !1, this._addSentinels(), this._observeTopSentinel(), this._observeBottomSentinel()))
        }
        destroy() {
            this.topObserver && this.topObserver.disconnect(), this.bottomObserver && this.bottomObserver.disconnect()
        }
        isSticky() {
            return this.sticky
        }
        ...
        _addSentinels() {
            ...
            t.classList.add(Nt.stickySentinel, Nt.stickySentinelTop), t.dataset.stickySentinelTop = "", this.container.classList.add(Nt.stickyContainer), this.stickyElement.insertAdjacentElement("beforebegin", t);
            const e = document.createElement("div");
            e.classList.add(Nt.stickySentinel, Nt.stickySentinelBottom), e.dataset.stickySentinelBottom = "", this.stickyElement.parentElement.appendChild(e)
        }
        _observeTopSentinel() {
            ...
            t && (this.topObserver = new IntersectionObserver(t => {
                t.forEach(t => {
                    ...
                    i && (this.sticky = !0, this.stickyElement.classList.add(Nt.stickyElement), this._fireEvent()), s && (this.sticky = !1, this.stickyElement.classList.remove(Nt.stickyElement), this._fireEvent())
                })
            ...
            if (t) {
                ...
                this.bottomObserver = new IntersectionObserver(t => {
                    t.forEach(t => {
                        ...
                        !r && o && (this.sticky = !0, this.stickyElement.classList.add(Nt.stickyElement), this._fireEvent()), a && (this.sticky = !1, this.stickyElement.classList.remove(Nt.stickyElement), this._fireEvent())
                    })
    ...
    class Rt {
        ...
        init() {
            this.container && (this.viewMoreButton = this.container.querySelector(Ft.viewMoreButton), this.viewMoreButton && (this.maxCount = parseInt(this.viewMoreButton.dataset.viewMoreMax, 10), this.countPerPage = parseInt(this.viewMoreButton.dataset.viewMoreStep, 10), this.currentCount = parseInt(this.viewMoreButton.dataset.viewMoreCurrent, 10), this.isLoading = !1, this._setupEventHandlers()))
        }
        _getEventHandlers() {
            return {
        ...
        _setupEventHandlers() {
            this.eventHandlers = this._getEventHandlers(), this.viewMoreButton.addEventListener("click", this.eventHandlers.onClickViewMoreHandler)
        }
        ...
        _loadItems() {
            if (!(this.isLoading || this.currentCount >= this.maxCount)) {
                ...
                this.isLoading = !0, fetch(t).then(t => t.text()).then(t => {
                    return (new DOMParser).parseFromString(t, "text/html")
                }).then(t => {
                    const e = [...t.querySelectorAll(Ft.viewMoreItem)];
                    this.currentCount < this.countPerPage && e.splice(0, this.currentCount), this.isLoading = !1, this.currentCount += e.length, this._updateButton(), this._updateLiveRegion(), this._fireEvent(Bt.success, {
                        items: e
                    })
                }).then(() => {
        ...
        _updateSPRBadges() {
            window.SPR && window.SPR.initDomEls && window.SPR.loadBadges && (window.SPR.initDomEls(), window.SPR.loadBadges())
        }
        _updateButton() {
            this.viewMoreButton.dataset.viewMoreCurrent = this.currentCount, this.currentCount >= this.maxCount && this.viewMoreButton.classList.add(Dt.hidden)
        }
        _updateLiveRegion() {
            ...
            t.innerText = e, t.setAttribute("aria-hidden", !1), setTimeout(() => {
    ...
    t.register("featured-collections", {
        onLoad() {
            this.elements = this._getElements(), this.scroller = new st(this.container), this.scroller.init(), this.stickyNav = new Ot(this.container), this.stickyNav.init(), this.isProductModalEnabled = Boolean(this.container.dataset.productModal), this.isQuickAddEnabled = Boolean(this.container.dataset.quickAdd), this.hasSingleCollection = Boolean(this.container.dataset.singleCollection), this.isProductModalEnabled && (this.elements.productModalContent = document.querySelector(Wt.productModalContent)), this._setupProductCards(), this._setupEventHandlers(), theme.cartQuantity && theme.cartQuantity.updateQuantityIndicatorElements(!1, this.container)
        },
        onUnload() {
            this.elements.tabs && (this.stickyNav.destroy(), this.scroller.destroy(), this.elements.tabs.forEach(t => {
                t.removeEventListener("click", this.eventHandlers.onClickTabHandler), t.removeEventListener("keydown", this.eventHandlers.onKeyDownTabHandler)
            }))
        },
        onBlockSelect(t) {
        ...
        _getElements() {
            return {
                ...
                tabsPanel: this.container.querySelectorAll(Wt.featuredCollectionsTabsPanel),
                tabsPanelWrapper: this.container.querySelector(Wt.featuredCollectionsWrapper)
            }
        },
        _getEventHandlers() {
            return {
        ...
        _setupEventHandlers() {
            this.eventHandlers = this._getEventHandlers(), this.elements.tabsPanel.forEach(t => {
                if (t.dataset.viewMore) {
                    new Rt(t).init(), t.addEventListener("viewmore_loaded", this.eventHandlers.onViewMoreLoaded)
                }
            }), this.elements.tabs && !this.hasSingleCollection && this.elements.tabs.forEach(t => {
                t.addEventListener("click", this.eventHandlers.onClickTabHandler), t.addEventListener("keydown", this.eventHandlers.onKeyDownTabHandler), t.addEventListener("keyup", this.eventHandlers.onKeyUpTabHandler)
            })
        },
        _setupProductCards() {
        ...
        onViewMoreLoaded(t) {
            ...
            e.forEach((t, e) => {
                ...
                if (a && 0 === e && a.focus(), this.isProductModalEnabled || this.isQuickAddEnabled) {
        ...
        onKeyDownTabHandler(t) {
            [D.HOME, D.END, D.RIGHT, D.LEFT].includes(t.key.toLowerCase()) && t.preventDefault()
        },
        onKeyUpTabHandler(t) {
            const e = t.currentTarget,
        ...
        showCollectionPanel(t) {
            ...
            this.stickyNav.isSticky() && (document.dispatchEvent(new CustomEvent("featuredCollectionTabClicked")), window.scrollTo({
                top: n
            })), this.elements.tabs.forEach(t => {
                t.classList.remove(Qt.featuredCollectionsTabActive), t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", -1), delete t.dataset.featuredCollectionsSelectedTab, t.blur()
            }), e.classList.add(Qt.featuredCollectionsTabActive), e.setAttribute("aria-selected", !0), e.setAttribute("tabindex", 0), e.dataset.featuredCollectionsSelectedTab = !0, e.focus(), this.scroller.makeElementVisible(e);
            const i = this.elements.tabsPanel[t];
            i && (this.elements.tabsPanel.forEach(t => {
                t.classList.remove(Qt.featuredCollectionsPanelVisible), t.classList.remove(Qt.featuredCollectionsPanelActive)
            }), i.classList.add(Qt.featuredCollectionsPanelActive), window.requestAnimationFrame(() => i.classList.add(Qt.featuredCollectionsPanelVisible)))
        }
    });
    const Ut = {
        productCard: "[data-product-card]",
    ...
    t.register("custom-content", {
        onLoad() {
            ...
            this.container.dataset.slider && this._prepareGallery(), this.isProductModalEnabled = Boolean(this.container.dataset.productModal), this.isProductModalEnabled && t.length > 0 && this._setupProductCards()
        },
        onUnload() {
        ...
        _prepareGallery() {
            this.galleryElement = this.container.querySelector(Ut.dataSlide), this.galleryElement && (this._addGalleryMediaQueryListener(), this.galleryMediaQueryListener.matches && (this._initializeGallery(), this.gallery.addAccessibilityAttr()))
        },
        _disableGalleryMode() {
            this.gallery.removeAccessibilityAttr(), this.gallery.resetTransformation(), this.gallery.state.useAriaHidden = !1, this.gallery.destroy()
        },
        _switchToGalleryMode() {
            const t = this._initializeGallery();
            this.gallery.state.useAriaHidden = !0, this.gallery.hideMedia(), this.gallery.addAccessibilityAttr(), t || this.gallery.bindEvents()
        ...
        _addGalleryMediaQueryListener() {
            this.galleryMediaQueryListener = window.matchMedia(c("medium", "max")), this.galleryMediaQueryListener.addListener(t => {
                if (t.matches) return void this._switchToGalleryMode();
    ...
    (() => {
        ...
        t && (o(t), t.addEventListener("change", t => {
    ...
    (() => {
        ...
        document.body.hasAttribute(Kt.templatePassword) && document.querySelector(Vt.passwordInput).hasAttribute(Kt.error) && window.addEventListener("DOMContentLoaded", () => {
            setTimeout(() => {
                t()
            }, 50)
        })
    ...
    (() => {
        function t(t, e, n) {
            ...
            "false" === e.getAttribute("aria-expanded") ? (n.classList.remove(Jt.hidden), e.setAttribute("aria-expanded", !0)) : (n.classList.add(Jt.hidden), e.setAttribute("aria-expanded", !1)), i.hasAttribute(zt.addNewAddressToggle) || e.focus()
        }
        ...
        function e(t, e) {
            ...
            "false" === o.getAttribute("aria-expanded") ? (r.classList.remove(Jt.hidden), o.setAttribute("aria-expanded", !0)) : (r.classList.add(Jt.hidden), o.setAttribute("aria-expanded", !1)), n.hasAttribute(zt.editAddressFormToggle) || o.focus()
        }
        ...
        if (i) {
            ...
            s && (function () {
                ...
                r.addEventListener("click", e => t(e, r, s)), o.addEventListener("click", e => t(e, r, s)), a.forEach(t => t.addEventListener("click", t => e(t, a))), c.forEach(t => t.addEventListener("click", () => {
                    e(event, a)
    ...
    (() => {
        function t(t, n) {
            ...
            n ? (i.classList.add(Xt.hidden), s.classList.remove(Xt.hidden)) : (i.classList.remove(Xt.hidden), s.classList.add(Xt.hidden)), t.setAttribute("tabindex", "-1"), t.focus(), t.addEventListener("blur", () => {
        ...
        new $, t.load("*"), window.carts = Array.from(document.querySelectorAll("[data-cart]"), t => {
            const e = new K(t);
            return e.init(), e
        ...
        }), theme.cartQuantity = new J, theme.cartQuantity.updateLocalCartState();
